...
Yii::app()->params['IDGridview'] = 'rrhh-tipo-contrato-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-tipo-contrato-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">               
                <h1>Tipo de Contratos <!--<small>Admin Tipo de Contratos</small>--></h1>
                <br />
                <div class="content">
                	<?php echo CHtml::link('Crear', array('rrhhTipoContrato/create'), array('class' => 'btn btn-square btn-info')); ?>                                        
