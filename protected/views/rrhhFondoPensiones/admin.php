...
Yii::app()->params['IDGridview'] = 'rrhh-fondo-pensiones-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-fondo-pensiones-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Fondo de Pensiones <!--<small>Admin Fondo de Pensiones</small>--></h1>
                <br />
                <div class="content">
                	<?php echo CHtml::link('Crear', array('rrhhFondoPensiones/create'), array('class' => 'btn btn-square btn-info')); ?>                                        
