<?php
Yii::app()->params['IDGridview'] = 'rrhh-notifications-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-notifications-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
               ...
               <br />
                <div class="content">
                    <?php echo CHtml::link('Crear', array('rrhhNotifications/create'), array('class' => 'btn btn-square btn-info')); ?>                      
                </div>                
