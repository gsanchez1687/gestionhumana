...
Yii::app()->params['IDGridview'] = 'rrhh-area-odepartamentos-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-area-odepartamentos-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Areas/Departamentos</h1>    
                <br/>          
                <div>
                     <?php echo CHtml::link('Crear', array('rrhhAreaODepartamentos/create'), array('class' => 'btn btn-info btn-square')); ?>                      
                </div>
                <div class="menu-tool">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                   <?php $this->widget('zii.widgets.grid.CGridView', array(
                            'id'=>'rrhh-area-odepartamentos-grid',
