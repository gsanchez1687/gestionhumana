...
*/
Yii::app()->params['IDGridview'] = 'rrhh-poliza-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-poliza-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Polizas <!--<small>Admin Polizas</small>--></h1>
                <br />
                <div class="content">
                	<?php echo CHtml::link('Crear', array('rrhhPoliza/create'), array('class' => 'btn btn-square btn-info')); ?>                                        
