...
*/
Yii::app()->params['IDGridview'] = 'rrhh-preaviso-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-preaviso-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
               ...
               <br />        
               <div class="container">
                     <?php echo CHtml::link('Crear', array('rrhhPreaviso/create'), array('class' => 'btn btn-info btn-square')); ?>                      
                </div>
                <div class="menu-tool">
