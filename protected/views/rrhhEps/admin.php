...
Yii::app()->params['IDGridview'] = 'rrhhrrhh-eps--grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-eps-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>EPS <!--<small>Admin EPS</small>--></h1>              
                <br />
                <div class="content">
                	<?php echo CHtml::link('Crear', array('rrhhEps/create'), array('class' => 'btn btn-square btn-info')); ?>                                        
