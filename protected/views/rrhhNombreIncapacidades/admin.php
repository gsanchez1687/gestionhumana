 ...
 */
Yii::app()->params['IDGridview'] = 'rrhh-nombre-incapacidades-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-nombre-incapacidades-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Nombre Incapacidades <!--<small>Admin Incapacidades</small>--></h1>               
                <br />
                <div class="content">
                	<?php echo CHtml::link('Crear', array('rrhhNombreIncapacidades/create'), array('class' => 'btn btn-square btn-info')); ?>                                        
            ...
            <div class="panel-body">
                <div class="table-responsive">
                   <?php $this->widget('zii.widgets.grid.CGridView', array(
                        'id'=>'rrhh-nombre-incapacidades-grid',
