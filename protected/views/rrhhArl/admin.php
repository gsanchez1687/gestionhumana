...
*/
Yii::app()->params['IDGridview'] = 'rrhh-arl-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-arl-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>ARL <!--<small>Admin ARL</small>--></h1>
                <br />
                <div class="content">
                	<?php echo CHtml::link('Crear', array('rrhhArl/create'), array('class' => 'btn btn-square btn-info')); ?>                                        
