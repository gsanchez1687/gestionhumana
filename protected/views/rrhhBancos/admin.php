...
$this->menu=array(
	array('label'=>'List RrhhBancos', 'url'=>array('index')),
	array('label'=>'Create RrhhBancos', 'url'=>array('create')),
);
*/
Yii::app()->params['IDGridview'] = 'rrhh-bancos-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-bancos-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Bancos <!--<small>Admin Bancos</small>--></h1>
                <br />
                <div class="content">
                	<?php echo CHtml::link('Crear', array('rrhhBancos/create'), array('class' => 'btn btn-square btn-info')); ?>                                        
