...
$this->menu=array(
	array('label'=>'List RrhhNombreExamenes', 'url'=>array('index')),
	array('label'=>'Create RrhhNombreExamenes', 'url'=>array('create')),
);
*/
Yii::app()->params['IDGridview'] = 'rrhh-nombre-examenes-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-nombre-examenes-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Nombre de Examenes <!--<small>Admin Nombre de Examenes</small>--></h1>
                <br />
                <div class="content">
                	<?php echo CHtml::link('Crear', array('rrhhNombreExamenes/create'), array('class' => 'btn btn-square btn-info')); ?>                                        
