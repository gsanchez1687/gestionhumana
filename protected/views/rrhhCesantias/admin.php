...
Yii::app()->params['IDGridview'] = 'rrhh-cesantias-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-cesantias-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Cesantias <!--<small>Admin Cesantias</small>--></h1>
                <br />
                <div class="content">
                	<?php echo CHtml::link('Crear', array('rrhhCesantias/create'), array('class' => 'btn btn-square btn-info')); ?>                                        
