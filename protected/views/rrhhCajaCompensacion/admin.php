...
Yii::app()->params['IDGridview'] = 'rrhh-caja-compensacion-grid';
...
$('.search-form form').submit(function(){
	$('#rrhh-caja-compensacion-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Caja de Compensacion <!--<small>Admin Caja Compensacion</small>--></h1>
                <br />
                <div class="content">
                	<?php echo CHtml::link('Crear', array('rrhhCajaCompensacion/create'), array('class' => 'btn btn-square btn-info')); ?>                                        
            ...
            <div class="panel-body">
                <div class="table-responsive">
                   <?php $this->widget('zii.widgets.grid.CGridView', array(
                            'id'=>'rrhh-caja-compensacion-grid',
