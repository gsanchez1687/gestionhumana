...
class PageSize extends CWidget
{
    ...
    public function run()
    {
        ...
        $this->dropDownListHtmlOptions['data-toggle'] = "tooltip";
        $this->dropDownListHtmlOptions['data-placement'] = "left"; 
        $this->dropDownListHtmlOptions['title'] = "Cantidad de registros a mostrar por página";
