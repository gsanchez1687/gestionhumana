...
/**
 * This is the model class for table "rrhh_poliza".
 *
 * The followings are the available columns in table 'rrhh_poliza':
 * @property integer $id
 ...
 */
class RrhhPoliza extends CActiveRecord
{
	/**
	 ...
	 * @return RrhhPoliza the static model class
	 */
