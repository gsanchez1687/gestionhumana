 ...
 */
class UsersLocationCities extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('users_location_states_id, orden_id', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'name' => 'Name',
			'code' => 'unique:1',
			'users_location_states_id' => 'type:select;table:users_location_states',
			'orden_id' => 'Orden',
		);
	}
	 ...
	 * @return UsersLocationCities the static model class
	 */
