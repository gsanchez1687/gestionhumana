...
/**
 * This is the model class for table "rrhh_arl".
 *
 * The followings are the available columns in table 'rrhh_arl':
 * @property integer $id
 ...
 */
class RrhhArl extends CActiveRecord
{
	/**
	 ...
	 * @return RrhhArl the static model class
	 */
